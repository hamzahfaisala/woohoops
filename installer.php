...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211104_hoopsindonesia_bbb6463b3bb5b74a7114_20211108072850_archive.zip';
	const ARCHIVE_SIZE		 = '170953038';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bbb6463-08072850';
    const SECONDARY_PACKAGE_HASH = '9547eec-08072850';
	const VERSION			 = '1.4.3';
